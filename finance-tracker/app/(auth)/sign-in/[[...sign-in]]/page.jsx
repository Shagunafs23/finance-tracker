  ...
  <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
    <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
      ...
      <div className="hidden lg:relative lg:block lg:p-12">
        ...
        <h2 className="mt-6 text-2xl font-medium text-white sm:text-3xl md:text-4xl">
        Welcome to FinanceTrack
        </h2>

        <p className="mt-4 leading-relaxed text-white/90">
        Track your finances, set budgets, and achieve your financial goals with ease.
        Our app helps you monitor your spending, savings, and investments, making personal finance management simpler than ever.
        </p>
      </div>
    </section>
    ...
    >
      <div className="max-w-xl lg:max-w-3xl">
        <div className="relative -mt-16 block lg:hidden">
          ...
          <h1 className="mt-2 text-2xl font-medium text-gray-900 sm:text-3xl md:text-4xl">
          Welcome to FinanceTrack
          </h1>

          <p className="mt-4 leading-relaxed text-gray-500">
          Track your finances, set budgets, and achieve your financial goals with ease.
          Our app helps you monitor your spending, savings, and investments, making personal finance management simpler than ever.<br/><br/>
          </p>
        </div>
