...
function Footer() {
  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="text-center">
      <h2 className="text-3xl font-extrabold text-gray-900 sm:text-5xl">Tailor Your Finance Tracker</h2>

      <p className="mx-auto mt-4 max-w-sm text-gray-500">
      Personalize your finance tracker to align with your lifestyle. Manage your money your way!
      </p>
